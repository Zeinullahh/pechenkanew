...
export default function ColorBends({
  ...
  useEffect(() => {
    const material = materialRef.current;
    const container = containerRef.current;
    if (!material || !container || isStatic) return;
  ...
  return <div ref={containerRef} className={`w-full h-full overflow-hidden ${className}`} style={{ pointerEvents: 'none', ...style }} />;
}
