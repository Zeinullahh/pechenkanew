  ...
  return (
    ...
    >
      <section id="right-to-use">
        ...
        <p className="mb-4">
          <strong>1.1 Agreement Scope:</strong> These Terms of Service (&quot;Terms&quot;) govern your access to and use of the AI-CSD 1 Web Security &amp; Traffic Management component provided by Silence AI LLC (&quot;Silence AI,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). These Terms apply to you, the individual or entity accessing our services (&quot;you&quot; or &quot;your&quot;), and your employer or principal if you are acting on their behalf.
        </p>
        <p className="mb-4">
          <strong>1.2 Service Domain and Jurisdiction:</strong> The AI-CSD 1 Web Security &amp; Traffic Management system operates on the dedicated domain <strong>web-soc.silenceai.net</strong> — the Centralized Management Console (CMC) for the Web Security &amp; Traffic Management subsystem, accessible to administrators. These Terms of Service apply exclusively to services accessible through the aforementioned domain. Any services provided on different domains are subject to separate terms and policies.
        </p>
        <p className="mb-4">
      ...
      <section id="obligations">
        ...
        <p className="mb-4">
          <strong>3.3.1 System Version Updates:</strong> Silence AI reserves the right to create new versions of the system and make older versions unavailable, while maintaining the systems of active protection on the same IP address (the Agent of the &quot;Web Security &amp; Traffic Management&quot; component mentioned in the Terms of Use).
        </p>
        <p className="mb-4">
          <strong>3.3.2 IP Address Management:</strong> Silence AI may provide a new IP address for the Agent (which is a sub-system within the component called &quot;Web Security &amp; Traffic Management&quot;) and require the user to change the Agent&apos;s configuration to use the new IP address. This change will be communicated via a popup window in the Centralized Management Console (CMC) that can only be closed after the user has read it and agreed to change the IP address. After 3 months from the point when the popup window was sent, Silence AI will make the previous IP address unavailable.
        </p>
        <p className="mb-4">
      ...
      <section id="dpa">
        ...
        <p className="mb-4">
          <strong>12.2 Purpose and Scope:</strong> Processor will process Personal Data only as necessary to provide the Web Security &amp; Traffic Management Services ordered by Controller, specifically: ingesting, storing, parsing, analyzing, and visualizing web server logs that Controller&apos;s systems supply to Processor (including logs collected via the Global Shield agent/proxy) for security, threat detection, and display in the Centralized Management Console (CMC). Processor will not process Personal Data for any other purpose without Controller&apos;s documented requests.
        </p>
        <p className="mb-4">
